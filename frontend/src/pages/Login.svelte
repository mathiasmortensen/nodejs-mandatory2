  ...
  <div class="top-div">
    <div class="login-div">
      ...
      >
        ...
        <button type="button" class="btn" onclick={() => (view = "Forgot")}
          >Glemt kodeord</button
        >
      </form>
    </div>

    <button type="button" class="btn" onclick={() => (view = "Signup")}
      >Signup</button
    >
  </div>
{:else if view === "Signup"}
  <div class="top-div">
    ...
    <button type="button" class="btn" onclick={() => (view = "Login")}
      >Skift til Login</button
    >
  </div>
{:else if view === "Forgot"}
  <div class="top-div">
    <div class="signup-div">
      ...
      >
        ...
        <input
          type="text"
          placeholder="Email eller Username"
          bind:value={identifier}
        />
